...
function Home() {
  ...
  return (
    <div>
      ...
      {/* Courses */}
      <div className="home-course-container mt-4">
        <h1 className="text-dark text-center">Our Courses</h1>
        <Carousel>
          <div className="row">
            {courses.map((course) => (
              <div
                className=" rounded-card-c mb-4"
                style={{ margin: "10px" }}
                key={course._id}
              >
                <Link
          ...
          <div className="row">
            {teachers.map((teacher) => (
              <div className="col-md-2" key={teacher._id}>  
                {!teacher.isBlock && teacher.isTeacherApproved ? (
          ...
          {pricingData.map((pricingPlan, index) => (
            <div className="pricing-card" key={index}>
              <div className="pricing-card-header">
                ...
                <h4 className="pricing-plan-name">{pricingPlan.planName}</h4>
              </div>
